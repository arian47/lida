...
providers = {
    "openai": {
        ...
        "models": [
            ...
            {"name": "gpt-3.5-turbo", "max_tokens": 16384},
        ],
    },
    "gemini": {
        "name": "Google Gemini",
        ...
        "models": [
            {"name": "gemini-2.0-flash", "max_tokens": 1048576},
            {"name": "gemini-2.0-flash-lite", "max_tokens": 1048576},
    ...
    "minimax": {
        ...
        "models": [
            {"name": "MiniMax-M2.5", "max_tokens": 1000000},
            {"name": "MiniMax-M2.5-highspeed", "max_tokens": 1000000},
            {"name": "MiniMax-M2.1", "max_tokens": 1000000},
            {"name": "MiniMax-M2", "max_tokens": 1000000},
        ],
    },
}
